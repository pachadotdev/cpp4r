...
[[cpp11::register]] doubles_matrix<> add_two_cpp11_(const doubles_matrix<>& a, const doubles_matrix<>& b) {
  int nrow = a.nrow();
  int ncol = a.ncol();
...
[[cpp11::register]] doubles_matrix<> add_four_cpp11_(const doubles_matrix<>& a, const doubles_matrix<>& b,
...
[[cpp11::register]] doubles_matrix<> multiply_four_cpp11_(const doubles_matrix<>& a, const doubles_matrix<>& b,
  const doubles_matrix<>& c, const doubles_matrix<>& d) {
  int n = a.ncol();
  int n5 = n / 5;
  int n10 = n / 10;
...
[[cpp11::register]] doubles_matrix<> submatrix_manipulation_cpp11_(const doubles_matrix<>& a, const doubles_matrix<>& b) {
  int nrow = b.nrow();
  int ncol = b.ncol();
...
[[cpp11::register]] double multi_operation_cpp11_(const doubles_matrix<>& a, const doubles_matrix<>& b,
