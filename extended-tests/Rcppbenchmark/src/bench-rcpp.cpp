...
// [[Rcpp::export]]
NumericMatrix add_four_rcpp_(NumericMatrix a, NumericMatrix b,
  NumericMatrix c, NumericMatrix d) {
  int nrow = a.nrow();
  int ncol = a.ncol();
...
// [[Rcpp::export]]
NumericMatrix multiply_four_rcpp_(NumericMatrix a, NumericMatrix b,
  NumericMatrix c, NumericMatrix d) {
  int n = a.ncol();
  int n5 = n / 5;
  int n10 = n / 10;
...
// [[Rcpp::export]]
double multi_operation_rcpp_(NumericMatrix a, NumericMatrix b,
  NumericMatrix c) {
  int n = a.nrow();
