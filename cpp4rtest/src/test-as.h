...
context("as_cpp-C++") {
  test_that("as_cpp<integer>(INTSEXP)") {
    ...
    INTEGER(r)[0] = 42;
    auto x1 = cpp4r::as_cpp<int>(r);
    expect_true(x1 == 42);

    auto x2 = cpp4r::as_cpp<long>(r);
    expect_true(x2 == 42L);

    auto x3 = cpp4r::as_cpp<long long int>(r);
    expect_true(x3 == 42LL);

    auto x4 = cpp4r::as_cpp<unsigned>(r);
    expect_true(x4 == 42U);

    auto x5 = cpp4r::as_cpp<unsigned long>(r);
    expect_true(x5 == 42UL);
  ...
  test_that("as_cpp<integer>(REALSEXP)") {
    ...
    REAL(r)[0] = 42.5;
    expect_error(cpp4r::as_cpp<int>(r));
  ...
  test_that("as_cpp<integer>(NA)") {
    ...
    auto x2 = cpp4r::as_cpp<int>(i);
    expect_true(x2 == NA_INTEGER);

    auto x3 = cpp4r::as_cpp<int>(l);
  ...
  test_that("as_cpp<enum>(INTSEXP)") {
    ...
    for (Response e : {YES, NO, MAYBE, static_cast<Response>(42)}) {
      ...
      auto x = cpp4r::as_cpp<Response>(r);
      expect_true(x == e);
    }
  ...
  test_that("as_cpp<double>(REALSXP)") {
    SEXP r = PROTECT(Rf_allocVector(REALSXP, 1));
    REAL(r)[0] = 1.2;
    auto x1 = cpp4r::as_cpp<float>(r);
    expect_true(x1 == 1.2f);

    auto x2 = cpp4r::as_cpp<double>(r);
    expect_true(x2 == 1.2);

    auto x3 = cpp4r::as_cpp<long double>(r);
    expect_true(x3 == 1.2);
  ...
  test_that("as_cpp<double>(NA)") {
    ...
    auto x1 = cpp4r::as_cpp<double>(r);
    expect_true(ISNA(x1));

    auto x2 = cpp4r::as_cpp<double>(i);
    expect_true(ISNA(x2));

    auto x3 = cpp4r::as_cpp<double>(l);
    expect_true(ISNA(x3));
  ...
  test_that("as_cpp<bool>()") {
    ...
    LOGICAL(r)[0] = TRUE;
    auto x1 = cpp4r::as_cpp<bool>(r);
    expect_true(x1);

    LOGICAL(r)[0] = FALSE;
    auto x2 = cpp4r::as_cpp<bool>(r);
    expect_true(!x2);
  ...
  test_that("as_cpp<const char*>()") {
    SEXP r = PROTECT(Rf_allocVector(STRSXP, 1));
    SET_STRING_ELT(r, 0, Rf_mkChar("foo"));
    auto x1 = cpp4r::as_cpp<const char*>(r);
  ...
  test_that("as_cpp<std::string>()") {
    SEXP r = PROTECT(Rf_allocVector(STRSXP, 1));
    SET_STRING_ELT(r, 0, Rf_mkChar("foo"));
    auto x1 = cpp4r::as_cpp<std::string>(r);
    expect_true(x1 == "foo");
  ...
  test_that("as_cpp<std::vector<int>>()") {
    ...
    auto x1 = cpp4r::as_cpp<std::vector<int>>(r);
    expect_true(x1[0] == 1);
    expect_true(x1[1] == 2);
    expect_true(x1[2] == 3);
  ...
  test_that("as_cpp<std::vector<std::string>>()") {
    ...
    auto x1 = cpp4r::as_cpp<std::vector<std::string>>(r);
  ...
  test_that("as_cpp<std::deque<string>>()") {
    ...
    auto x1 = cpp4r::as_cpp<std::deque<std::string>>(r);
    expect_true(x1[0] == "foo");
    expect_true(x1[1] == "bar");
    expect_true(x1[2] == "baz");
  ...
  test_that("as_cpp<doubles>()") {
    ...
    auto x1 = cpp4r::as_cpp<cpp4r::doubles>(r);
    expect_true(x1[0] == 1.);
    expect_true(x1[1] == 2.);
    expect_true(x1[2] == 3.);
  ...
  test_that("as_sexp(integer)") {
    SEXP i1 = PROTECT(cpp4r::as_sexp(42));
    SEXP i2 = PROTECT(cpp4r::as_sexp(42L));
    SEXP i3 = PROTECT(cpp4r::as_sexp(42LL));
    SEXP i4 = PROTECT(cpp4r::as_sexp(42U));
    SEXP i5 = PROTECT(cpp4r::as_sexp(42UL));
    SEXP i6 = PROTECT(cpp4r::as_sexp(NA_INTEGER));
  ...
  test_that("as_sexp(floating_point)") {
    SEXP f1 = PROTECT(cpp4r::as_sexp(1.2f));
    SEXP f2 = PROTECT(cpp4r::as_sexp(1.2));
    SEXP f3 = PROTECT(cpp4r::as_sexp(1.2l));
    SEXP f4 = PROTECT(cpp4r::as_sexp(NA_REAL));
  ...
  test_that("as_sexp(bool)") {
    SEXP l1 = PROTECT(cpp4r::as_sexp(true));
    SEXP l2 = PROTECT(cpp4r::as_sexp(false));
  ...
  test_that("as_sexp(r_bool)") {
    SEXP l1 = PROTECT(cpp4r::as_sexp(cpp4r::r_bool(true)));
    SEXP l2 = PROTECT(cpp4r::as_sexp(cpp4r::r_bool(false)));
    SEXP l3 = PROTECT(cpp4r::as_sexp(cpp4r::r_bool()));
  ...
  test_that("as_sexp(raws)") {
    ...
    auto res1 = cpp4r::as_sexp(x);
    expect_true(cpp4r::detail::r_typeof(res1) == RAWSXP);
    ...
    auto res2 = cpp4r::as_sexp(y);
    expect_true(cpp4r::detail::r_typeof(res2) == RAWSXP);
  ...
  test_that("as_sexp(stringish)") {
    SEXP s1 = PROTECT(cpp4r::as_sexp("foo"));
    SEXP s2 = PROTECT(cpp4r::as_sexp(std::string("foo")));
    SEXP s3 = PROTECT(cpp4r::as_sexp(cpp4r::r_string("foo")));
  ...
  test_that("as_sexp(r_vector<int>)") {
    SEXP i1 = PROTECT(cpp4r::as_sexp(std::vector<int>({1, 2, 3})));
  ...
  test_that("as_sexp(r_vector<floating_point>)") {
    SEXP r1 = PROTECT(cpp4r::as_sexp(std::vector<double>({0.1, 0.2, 0.3})));
  ...
  test_that("as_sexp(r_vector<floating_point>)") {
    SEXP l1 = PROTECT(cpp4r::as_sexp(std::vector<bool>({true, false, true})));
  ...
  test_that("as_sexp(r_vector<std::string>)") {
    SEXP s1 = PROTECT(cpp4r::as_sexp(std::vector<std::string>({"foo", "bar", "baz"})));
  ...
  test_that("as_sexp(cpp4r::strings)") {
    cpp4r::writable::strings s({"foo", "bar", "baz"});
    cpp4r::strings s0(s);
    SEXP s1 = PROTECT(cpp4r::as_sexp(s0));
  ...
  test_that("as_sexp(initializer_list<const char*>)") {
    SEXP s1 = PROTECT(cpp4r::as_sexp({"foo", "bar", "baz"}));
